...
class RunDir:
    ...
    def find_reads_cycles(self):
        ...
        (reads, cycle_list, pairedend_run, indexed_reads) = RunDir.get_reads_cycles_from_runparameters(self.get_path())
        if reads is None:
    ...
    @classmethod
    def get_reads_cycles_from_runparameters(cls, run_dir):
